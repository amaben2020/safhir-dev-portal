    ...
    return [
      <tr key="main" onClick={this.toggleExpander}>
        {/* <td><img className="uk-preserve-width uk-border-circle" src={user.picture.thumbnail} width={48} alt="avatar" /></td> */}
         <td  className="approved-dropdown">    New Application 1.0{" "}</td>
        <td className="approved-dropdown-h2">    V2</td>
        <td className="approved-dropdown-h2">      6a3007c3-63a3-4777-a03b-4c599a367d57</td>  
        <td  className="approved-dropdown-img">       <img
                      className="approved-dropdown-img-svg"
                      src={copy}
                      alt="copy"
                    /></td>  
        <td   className="approved-dropdown-img-svg">        <img
                      className="approved-dropdown-img-svg"
                      src={down}
                      alt="down"
                    /></td>  
          ...
          <td className="uk-background-muted" colSpan={6}>
             <div ref="expanderBody" className="inner uk-grid">
              ...
              <div className="uk-width-3-4">
                ...
                <p>Date of birth 2: {formatDate(user.dob)}</p>
              </div>
            </div>  
          </td>
        </tr>
