  ...
  return (
   ...
   <>
        ...
        <Modal show={show} onHide={handleClose} >
          ...
          General. These Terms shall be governed in all respects by the laws of the State of Maryland without giving effect to its conflicts of law provisions.
           Both parties submit to the personal jurisdiction of and venue in the state and federal courts located in the judicial district that includes Elkridge,
            MD. The parties further agree that any cause of action arising under these Terms or our Privacy Policy shall exclusively be brought in such courts. If 
            any provision of these Terms is held to be invalid or unenforceable, then such provision shall be struck and the remaining provisions shall be enforced. 
            Headings are for reference purposes only and in no way define, limit, construe, or describe the scope or extent of such section. Onyx's failure to act with 
            respect to a breach by you or others does not constitute a waiver of its right to act with respect to subsequent or similar breaches. Subject to Section 19 
            (Relationship to Privacy Policy and Other Contracts), this agreement and the terms and conditions contained herein set forth the entire understanding and 
            agreement between Onyx and you with respect to the subject matter hereof and supersede any prior or contemporaneous understanding, whether written or oral. 
            Survival. In addition to any right or obligation that by its nature or intent is intended to survive the termination or expiration of these Terms, the following Sections 
shall survive any termination or expiration of thesThese Terms of Use (the "Terms of Use" or "Terms") apply to the services and information (collectively, the "Services")
 that Onyx Technology LLC ("Onyx," "we," "our", or "us") provides to you through our SAFHIR developer portal website at http://private.dev.safhir.io (our "Website" or "Site")
  (the Services, together with our Website, are referred to as the "SAFHIR Developer Portal"). These Terms govern your use of the SAFHIR Developer Portal and your provision of
   information while using the SAFHIR Developer Portal. Please read these Terms carefully because they impose legal obligations on you and on Onyx, and establish our legal relationship.
...
Effective Date; Legal Notice. The effective date of these Terms of Use is June 1, 2021. © 2021 Onyx Technology LLC. All Rights Reserved. 
          ...
          <Modal.Footer>
          <Button   className='agree' onClick={() => history.push('/devportal-home')}>
