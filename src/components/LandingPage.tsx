        ...
        <Col lg={7}>
          <div className="landingPage__wrapper-section2-textArea">
            ...
            <h3 className="landingPage__wrapper-section2-textArea-h3">
              ...
              SAFHIR applications frequently acces Protected Health Information
              (PHI) Since these application access sensitive health information,
              on behalf of members, additional precautions are taken when
              vetting individual developers, companies, and applications. An
              application is approved before production access is granted.
            </h3>
            ...
            <h3 className="landingPage__wrapper-section2-textArea-h3">
              ...
              credentials necessary for your application to work in production.
              The client_id and client_secret credentials are issued on a per
              organization (i.e. Payor) basis.{" "}
            </h3>
            ...
            <h3 className="landingPage__wrapper-section2-textArea-h3">
              ...
              company, HIE, and require access), contact us by phone or email so
              we can assist with account setup or recovery. In many cases, we
              will need to verify your identity and your affiliation with the
              data_provider.
            </h3>
          </div>
        </Col>
